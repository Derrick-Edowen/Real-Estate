...
function Mission() {
    ...
    return (
        <div className="missionIt">
            <div className="logorbox">
        <img className="logor" src={logor} />
        </div>
                <div className="descTextJfc">Our Mission!</div>
                <p className="descTexcp">In today's fast-paced digital age, having a robust online presence is no longer a luxury but a necessity for every real estate agent. At One Estate Web Services, we understand the unique needs of real estate professionals and offer bespoke website solutions tailored to showcase your expertise and listings. Our goal is to help you stand out in the crowded real estate market, attract more clients, and provide them with an exceptional browsing experience. By leveraging the latest technology and innovative designs, we create websites that are not only visually stunning but also functional and user-friendly.</p>
                <div className="descTextJfc">What We Offer!</div>
                <p className="descTexcp">One Estate Web Services is your one-stop solution for all your real estate website needs. Here’s a detailed look at what we offer:<br/><br/>
                ...
                <div className="descTextJfc">Why Choose One Estate Web Services?</div>
                <p className="descTexcp">Choosing One Estate Web Services means partnering with a company dedicated to your success. Here’s why we’re the best choice for your real estate website needs:<br/><br/>
                <strong>- Affordable Pricing:</strong> At just <strong>$40 USD</strong> per month, our subscription cost is transparent and affordable. There are no hidden fees, additional charges, or service/sign-up fees. What you see is what you get – a fully-featured, professional website at a price that won’t break the bank.<br/><br/>
                <strong>- Promotional Offers:</strong> Take advantage of our special promotions to get started at an even lower cost. Sign up with <strong>PROMO CODE: ONEESTATE</strong> and enjoy 15% off for the first two months. Plus, refer a colleague and receive your last month free – a one-time offer that’s too good to pass up.<br/><br/>
                ...
                <p className="descTexcp">Ready to elevate your real estate business and enhance your online presence? Getting started with One Estate Web Services is simple and straightforward:<br/><br/>
                ...
                <strong>4. Subscribe:</strong> Once your website is up, subscribe for continued service. Don’t forget to use <strong>PROMO CODE: ONEESTATE</strong> to enjoy 15% off for the first two months.<br/><br/>
