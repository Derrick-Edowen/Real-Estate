...
function Mission() {
    ...
    return (
        ...
        <img className="logor" src={logor} />
                ...
                <strong>- Promotional Offers:</strong> Take advantage of our special promotions to get started at an even lower cost. Sign up with <strong>PROMO CODE: ONEESTATE24</strong> and enjoy 15% off for the first two months. Plus, refer a colleague and receive your last month free – a one-time offer that’s too good to pass up.<br/><br/>
                ...
                <strong>4. Subscribe:</strong> Once your website is up, subscribe for continued service. Don’t forget to use <strong>PROMO CODE: ONEESTATE24</strong> to enjoy 15% off for the first two months.<br/><br/>
