...
function Footer() {
  ...
  return (
    <div>
      <div className={`feet ${visible ? 'visible' : ''}`} onClick={handleOpenLightbox}>
        ...
        <div className="lightboxf" onClick={handleCloseLightbox}>
          <div className="lightbox-contentf" onClick={(e) => e.stopPropagation()}>
            ...
            <p>In today's fast-paced digital age, having a robust online presence
               is no longer a luxury but a necessity for every REALTOR&reg;. At One Estate Web 
            ...
            <h2>What we Offer!</h2>
            <p>One Estate Web Services is your one-stop solution for all your real estate website needs. Here’s a detailed look at what we offer:

Personalized Websites: Work closely with our team of expert web developers to create a website that is uniquely yours. We provide extensive customization options, allowing you to modify every aspect of your site, from text and images to layout and design. This level of personalization ensures that your website truly reflects your brand and meets your specific needs.<br/>

Domain Name Selection: A memorable domain name can make a significant difference in how easily clients can find you. We offer the option to select your own domain name, subject to availability, to help reinforce your brand identity and improve your online visibility.<br/>

Future-Proof Features: Technology evolves, and so do we. Our commitment to you includes ongoing updates and the addition of new functionalities at no extra cost. Future plans include the integration of AI chatbots for enhanced client interaction, additional calculators to aid in financial decision-making, and improved Zillow property searches. Stay ahead of the curve with a website that evolves with the times.<br/>

Announcement System: Engage directly with your audience through our innovative announcement system. This feature allows you to post updates, advertisements, and communications in a social media-like format directly on your website. Keep your clients informed and engaged with the latest news and developments.<br/>

Comprehensive Property Searches: Powered by Zillow, our property search functionality covers both the USA and Canada. Your clients can effortlessly find their dream homes using our intuitive and powerful search tools, ensuring a seamless and satisfying browsing experience.</p>
            <h2>Why Choose Us?</h2>
            <p>Choosing One Estate Web Services means partnering with a company dedicated to your success. Here’s why we’re the best choice for your real estate website needs:
...
Ongoing Support and Maintenance: Your website will never be outdated. Enjoy free updates, new features, and maintenance to keep your site running smoothly and efficiently. We handle the technical aspects so you can focus on what you do best – selling real estate.<br/>

No Hidden Fees: We value transparency and honesty. Our pricing is straightforward with no hidden costs or surprise charges. You can trust that your investment is well-spent on quality services without any unexpected expenses.</p>
            <h2>Getting Started!</h2>
            <p>Ready to elevate your real estate business and enhance your online presence? Getting started with One Estate Web Services is simple and straightforward:
...
Launch and Advertise: Once your website is ready, launch it with your chosen domain name and start advertising. Use your new online platform to attract more clients and showcase your listings.<br/>

Referral Bonus: Spread the word and refer a colleague to One Estate Web Services. As a thank you, you’ll receive an additional month free – a fantastic way to share the benefits while gaining more from your subscription.<br/>

Stay Updated: Enjoy free future additions, updates, and maintenance, including exciting new features like AI chatbots, more calculators, and enhanced Zillow property searches. Your website will always be at the cutting edge of technology.<br/>
