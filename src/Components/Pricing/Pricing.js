...
<div className="descTexc"> - <strong>24/7 Support:</strong> Access expert assistance whenever you need it, ensuring peace of mind.</div>
<div className="descTextJfc">Limited Time Promotion</div>

<div className="descTexc"> - But that's not all! For a limited time, use promo code "ONEESTATE2024" and receive a generous 35% discount for the first 2 months of your subscription. This exclusive offer allows you to experience the full benefits of our services at an unbeatable price.</div>
